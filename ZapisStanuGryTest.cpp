...
void ZapisStanuGryTest::zapis(){
	...
	p_a = Aplikacja::getInstance().getGra().pobierzUzytkownika().pobierzPlanete(Identyfikator(1));
...
void ZapisStanuGryTest::odczyt(){
	...
	Planeta p_b = Aplikacja::getInstance().getGra().pobierzUzytkownika().pobierzPlanete(Identyfikator(1));
