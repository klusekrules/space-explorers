...
void SurowceTest::TworzenieSurowcaTest(){
	...
	auto& krysztalInfo = SpEx::Aplikacja::pobierzInstancje().pobierzGre().pobierzObiekt<SpEx::SurowceInfo>(2);
	...
	auto& metalInfo = SpEx::Aplikacja::pobierzInstancje().pobierzGre().pobierzObiekt<SpEx::SurowceInfo>(1);
