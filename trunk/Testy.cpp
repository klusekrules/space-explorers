...
bool Testy::test_KlasaLadownia(){
	...
	ObiektBase klasa( Ilosc(0) , Poziom( 2 ) , nullptr , Base( IdType( 10 ) ) );
	ObiektInfo *ptr = new ObiektInfo( Masa(1) , Objetosc(1) , Powierzchnia(1) ,Info(Tekst("Typ Pierwszy"), Tekst("Opis Typu pierwszego")),klasa );
	Obiekt *o = ptr->TworzEgzemplarz(Ilosc(30));
	klasa.setId(14);
	ObiektInfo *ptr2 = new ObiektInfo( Masa(1) , Objetosc(5) , Powierzchnia(1) ,Info(Tekst("Typ Pierwszy"), Tekst("Opis Typu pierwszego")),klasa );
...
bool Testy::test_tworzenieObiektow(){
	...
	ObiektBase klasa( Ilosc(4) , Poziom( 2 ) , nullptr , Base( IdType( 10 ) ) );
	Log::debug("Klasa bazowa");
	Log::debug<ObiektBase>(klasa);
	ObiektInfo * ptr = new ObiektInfo( Masa(0) , Objetosc(0) , Powierzchnia(0) ,Info(Tekst("Napis"), Tekst("Opis")),klasa );
...
bool Testy::test_KlasaObiektList(){
	...
	Obiekt a(ObiektBase( Ilosc(4) , Poziom( 2 ) , nullptr , Base( IdType( 10 ) ) ));
	Obiekt b(ObiektBase( Ilosc(4) , Poziom( 3 ) , nullptr , Base( IdType( 10 ) ) ));
	Obiekt c(ObiektBase( Ilosc(4) , Poziom( 2 ) , nullptr , Base( IdType( 10 ) ) ));
	Obiekt d(ObiektBase( Ilosc(4) , Poziom( 2 ) , nullptr , Base( IdType( 11 ) ) ));
	lista.add(a);
...
bool Testy::test_podstawoweDzialaniaKlas(){
	...
	ObiektBase objbase1( Ilosc(14), Poziom(20), nullptr, IdType(-2) );
	cout << "ZawartoϾ utworzonej klasy: " << objbase1.toString() << endl;
	ObiektBase objbase2( Ilosc(1), Poziom(20), nullptr, IdType(-2) );
	cout << "ZawartoϾ utworzonej klasy: " << objbase2.toString() << endl;
	ObiektBase objbase3( Ilosc(2), Poziom(10), nullptr, IdType(5) );
