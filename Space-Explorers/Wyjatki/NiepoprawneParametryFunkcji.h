...
namespace SpEx{
	...
	*/
	...
	public:
		...
		template< class... V >
		NiepoprawneParametryFunkcji(const STyp::Tekst& tPlik, const STyp::Tekst& funkcja, const STyp::Ilosc& iLinia, const STyp::Tekst& debug, const V&... tail)
			: Wyjatek(tPlik, funkcja, iLinia, debug, idNiepoprawneParametryFunkcji, tytulNiepoprawneParametryFunkcji, trescNiepoprawneParametryFunkcji)
		{
