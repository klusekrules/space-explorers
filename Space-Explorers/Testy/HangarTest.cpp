...
void HangarTest::startTestow(){
	...
	auto& statekInfo = gra->pobierzObiektInfo<SpEx::StatekInfo>(STyp::Identyfikator(5));
	auto& statekInfo2 = gra->pobierzObiektInfo<SpEx::StatekInfo>(STyp::Identyfikator(6));
	auto& statekInfo3 = gra->pobierzObiektInfo<SpEx::StatekInfo>(STyp::Identyfikator(7));
	auto& statekInfo4 = gra->pobierzObiektInfo<SpEx::StatekInfo>(STyp::Identyfikator(8));
