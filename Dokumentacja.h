 ...
 * <ObronaInfo>
 * \endcode
 * \subsection surowceinfo_subsection Opis wêz³a \c SurowceInfo
 ...
 * </SurowceInfo>
 * \endcode
 * \subsection statekinfo_subsection Opis wêz³a \c StatekInfo
 * Drugim wa¿nym obiektem jest Statek. Obiekt ten jest mocno robudowany, zacznê wiêc od opisu podstawowych atrybutów:
 * \li \c id - Unikalny identyfikator obiektu, nie mo¿e siê powtarzaæ w ¿adnym ze zdefiniowanych obiektów.
 * \li \c nazwa - Nazwa obiektu u¿ywana w grze.
 * \li \c poziom - Podstawowy poziom obiektu przypisywany przy tworzeniu.
 * \li \c powierzchnia - Powierzchnia jak¹ zajmuje jeden obiekt.
 ...
 * \subsubsection jednostka_latajaca Opis wêz³a \c JednostkaLatajacaInfo
 ...
 * \subsubsection jednostka_ataujaca Opis wêz³a \c JednostkaAtakujacaInfo
 ...
 * \subsubsection ladownia Opis wêz³a \c LadowniaInfo
 * \subsubsection hangar Opis wêz³a \c HangarInfo
 * \subsection technologiainfo_subsection Opis wêz³a \c TechnologiaInfo
 * \subsection budynekinfo_subsection Opis wêz³a \c BudynekInfo
 * \subsection obronainfo_subsection Opis wêz³a \c ObronaInfo
 * 
 * 
*/
