...
void ObiektListTest::startTestow(){
	...
	a = std::shared_ptr<SpEx::Statek>(gra.pobierzStatek(STyp::Identyfikator(11)).tworzEgzemplarz(STyp::Ilosc(8)));
	b = std::shared_ptr<SpEx::Statek>(gra.pobierzStatek(STyp::Identyfikator(12)).tworzEgzemplarz(STyp::Ilosc(8)));
	c = std::shared_ptr<SpEx::Statek>(gra.pobierzStatek(STyp::Identyfikator(13)).tworzEgzemplarz(STyp::Ilosc(8)));
	d = std::shared_ptr<SpEx::Statek>(gra.pobierzStatek(STyp::Identyfikator(14)).tworzEgzemplarz(STyp::Ilosc(8)));
...
void ObiektListTest::podstawowyTest(){
	...
	SpEx::Statek& sTmp1 = *lista.pobierz(STyp::Identyfikator(12));
	UNIT_TEST_ASSERT_EQUAL(STyp::Identyfikator(12), sTmp1.pobierzIdentyfikator());
	UNIT_TEST_ASSERT_TRUE(lista.usun(STyp::Identyfikator(11)));
	std::shared_ptr<SpEx::Statek> sTmp2 = lista.wyjmij(STyp::Identyfikator(14));
	UNIT_TEST_ASSERT_EQUAL(STyp::Identyfikator(14), sTmp2->pobierzIdentyfikator());
